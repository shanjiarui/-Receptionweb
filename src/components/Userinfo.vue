                ...
                <tr valign="top">
                  ...
                  <td>
                    ...
                    <p>
                      ...
                      <span>邮箱：</span><span v-model="email">{{email}}</span>
<!--                      您还没有通过邮件认证 <a href="#" style="color:#ff4e00;">点此发送认证邮件</a>-->
        ...
        <div class="btmbg">
          <div class="btm">
            <span>{{name}}</span>备案/许可证编号：蜀ICP备12009302号-1-www.dingguagua.com   Copyright © 2015-2018 尤洪商城网 All Rights Reserved. 复制必究 , Technical Support: Dgg Group <br />
