        ...
        <div class="content mar_20">
          <div class="two_bg">
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <tr v-for="specas in specs">
                <td>
                  <div class="c_s_img"><img src="../assets/images//c_3.jpg" width="73" height="73" /></div>
                  {{specas[0].goods_name}}
                </td>
                <td align="center">颜色：{{specas[0].specs_name}}</td>
                <td align="center">{{specas[0].num}}</td>
                <td align="center" style="color:#ff4e00;">￥{{specas[0].all_price}}</td>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              <tr>
                <td align="right">
                  商品总价: <font color="#ff4e00">￥{{price}}</font>
                </td>
              </tr>
              <tr height="70">
                <td align="right">
              ...
              <tr height="70">
                <td align="right">
<!--                  <router-link to="/Buycarthree">-->
                  <a v-on:click="add_order"><img src="../assets/images/btn_sure.gif" /></a>
<!--                </router-link>-->
                </td>
              </tr>
            </table>
...
<script>
    export default {
        ...
        methods:{
          add_order(){
            let _this=this
            axios.post(this.url+"add_order",{
              token:localStorage.getItem("token"),
              order:_this.user,
              user_id:localStorage.getItem("id"),
              price:_this.price,
              specs_id:_this.$route.query.arr
            })
              .then(function (response){
                _this.order_id=response.data.order_id
                location.href="http://localhost/blog/public/api/index?price="+_this.price+"&order_id="+_this.order_id+"&token="+localStorage.getItem("token")
              })
        ...
        mounted(){
          ...
          axios.post(this.url+"go_address",{
            token:localStorage.getItem("token"),
            id:localStorage.getItem("id"),
          })
            .then(function (response){
              // _this.user_name=response.data.data[0].name
