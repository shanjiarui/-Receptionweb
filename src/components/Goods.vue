        ...
        <div class="content">
          ...
          <div id="tsShopContainer">
            ...
            <div id="tsPicContainer">
              ...
              <div id="tsImgSCon">
                <ul>
                  <li rel="MagicZoom" class="tsSelectImg"><img src="../assets/images/ps1.jpg" tsImgS="../assets/images/ps1.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps2.jpg" tsImgS="../assets/images/ps2.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps3.jpg" tsImgS="../assets/images/ps3.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps4.jpg" tsImgS="../assets/images/ps4.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps1.jpg" tsImgS="../assets/images/ps1.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps2.jpg" tsImgS="../assets/images/ps2.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps3.jpg" tsImgS="../assets/images/ps3.jpg" width="79" height="79" /></li>
                  <li rel="MagicZoom"><img src="../assets/images/ps4.jpg" tsImgS="../assets/images/ps4.jpg" width="79" height="79" /></li>
                </ul>
...
<!--              <div id="tsImgSArrR" onclick="tsScrollArrRight()"></div>-->
          ...
          <div class="pro_des">
            ...
            <div class="des_price">
              本店价格：<b v-model="price">{{price}}</b><br />
              消费积分：<span v-model="integral">{{integral}}</span>
            </div>
            <div class="des_choice">
              <span class="fl">型号选择：</span>
              <ul>
                <li class="all_specs" v-on:click="goods_specs($event)" v-for="specsa in specs" v-bind:value="specsa.id" v-bind:id="specsa.id" v-bind:about="specsa.goods_attr_id">{{specsa.goods_attr_id}}</li>
...
<!--                <li>100ml<div class="ch_img"></div></li>-->
            ...
            <div class="des_join">
              <div class="j_nums">
                <input type="text" v-model="num" name="" class="n_ipt" />
                <input type="button" value="" v-on:click="add_num" class="n_btn_1" />
                <input type="button" value="" v-on:click="cut_num" class="n_btn_2" />
              </div>
              <span class="fl"><a v-on:click="buy_car"><img src="../assets/images/j_car.png" /></a></span>
            </div>
          </div>
...
<script>
    export default {
        ...
        methods:{
          goods_specs(e){
            var _this=this
            axios.get(this.url+"price?specs_id="+e.target.attributes[2].value)
              .then(function (response) {
                _this.price=response.data.price+"人民币"
                // console.log(_this.price)
                _this.specs_id=e.target.attributes[2].value//将选中的货品id存起来方便添加到购物车的时候取货品ID
                _this.integral=response.data.price/10+"R"
                _this.specs_name=$('#'+_this.specs_id).attr('about')//将选中货品名字存储方便添加购物车
              })
            ...
            if (this.specs_id=='') {
              ...
              // }else{
                ...
                axios.post(this.url+"add_buycar",{
                  ...
                  .then(function (response) {
                    if (response.data.status!='succsee') {
                      alert('添加成功!')
                      _this.num=1
                    }
                  })
                  .catch(function (error) { // 请求失败处理
                    var str=confirm(error+"是否重新登陆!")
                    if (str==true) {
