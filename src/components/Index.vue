    ...
    <div class="fresh_mid" >
      <ul>
        <li v-for="(nk,val) in op">
          ...
          <div class="img"><router-link :to="'/goods?goods_id='+nk.goods_id"><img src="../assets/images/food_1.jpg" width="185" height="155" /></router-link></div>
        </li>
      </ul>
    </div>
  </div>
