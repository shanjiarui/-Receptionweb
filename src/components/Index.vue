        ...
        <ul>
          <li v-for="cates in cate">
            <div class="fj">
              ...
              <span class="fl">{{cates.cate_name}}</span>
            </div>
            <div class="zj">
              <div class="zj_l">
                <div class="zj_l_c" v-for="son in cates.son">
                  <h2>{{son.cate_name}}</h2>
                  <a href="#" v-for="sons in son.son">{{sons.cate_name}}</a>
                </div>
              </div>
              <div class="zj_r">
...
<div class="i_bg bg_color">
            ...
            <ul class="featureUL" style="margin: 0px; padding: 0px; position: relative; list-style-type: none; z-index: 1; width: 3600px; left: -2400px;">
              <li class="featureBox" style="overflow: hidden; float: left; width: 238px; height: 228px;">
                <div class="box">
                  ...
                  <div class="imgbg">
                    <img width="160" height="136" src="../assets/images/hot1.jpg">
                  </div>
                  <div class="name">
              ...
              <li class="featureBox" v-for="(key,value) in info" style="overflow: hidden; float: left; width: 238px; height: 228px;">
              <div class="box">
                <div class="h_icon"><img width="50" height="50" src="../assets/images/hot.png">
                </div>
                <div class="imgbg">
    ...
    <div class="fresh_mid">
      <ul>
        <li v-for="(key,value) in info">
          <div class="name"><a href="#">{{key.goods_id}}</a></div>
          <div class="price">
            <font><span>{{key.goods_name}}</span></font> &nbsp;
          </div>
  ...
  <div class="content">
    <div class="fresh_mid" >
      <ul>
        <li v-for="(nk,val) in op">
          <div class="name"><a href="#">{{nk.goods_name}}</a></div>
          <div class="price">
...
<!--    </div>-->
<!--  </div>-->
<!--  &lt;!&ndash;End 数码家电 End&ndash;&gt;-->
<!--  &lt;!&ndash;Begin 猜你喜欢 Begin&ndash;&gt;-->
<!--  <div class="i_t mar_10">-->
...
<!--  &lt;!&ndash;End 猜你喜欢 End&ndash;&gt;-->
  ...
  <div class="btmbg">
    <div class="btm">
      ...
      <img src="../asset/../assets/images/b_1.gif" width="98" height="33" /><img src="../asset/../assets/images/b_2.gif" width="98" height="33" /><img src="../asset/../assets/images/b_3.gif" width="98" height="33" /><img src="../asset/../assets/images/b_4.gif" width="98" height="33" /><img src="../asset/../assets/images/b_5.gif" width="98" height="33" /><img src="../asset/../assets/images/b_6.gif" width="98" height="33" />
    </div>
  </div>
  <!--End Footer End -->
<div v-for="(key,value) in goods">
...
<script>
  ...
  export default {
    ...
    mounted () {
      var _this=this
      axios.get('http://localhost/blog/public/hot')
        .then(function (response) {
          _this.info=response.data
        })
      axios.get('http://localhost/blog/public/tree')
        .then(function (response) {
          _this.cate=response.data.data
        })
      axios.get('http://localhost/blog/public/home_goods')
        .then(function (response) {
